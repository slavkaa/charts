...
<div class="container">
    ...
    <div class="jumbotron" style="background-color: #fefefe; border: 1px solid #ddd;text-align: center;">
        <h4>"Ви маєте текстові данні. Елементи мають (лінійно) слідувати один за одним. З кожним кроком значення певного параметру зменшується."</h4>
        <h2>Воронка</h2>
        <div style="text-align: center; width: 100%;">
            <img src="img/chart_illustrations/voronka.png" style="width: 200px;" />
        </div>
    </div>
