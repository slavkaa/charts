...
<div class="container">
    ...
    <div class="jumbotron" style="background-color: #fefefe; border: 1px solid #ddd;text-align: center;">
        <h4>"Елементи мають (лінійно) слідувати один за одним, <br/> важливо показати що це послідовність,
            діаграмма містить тільки короткі тексти."</h4>
        <h2>Лінійна горизонтальна послідовність</h2>
        <div style="text-align: center; width: 100%;">
            <img src="img/chart_illustrations/algorithm-linear.png" style="width: 200px;" />
        </div>
    </div>
